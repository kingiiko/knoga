...
screen -S ]]..Redis:get(SshId.."Info:Redis:User")..[[ ./KING
done
]])
Run:close()
...
os.execute('chmod +x KING;chmod +x Run;./Run')
end
...
KING = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..KING)
LuaTele = luatele.set_config{api_id=19544881,api_hash='a7daae15700e58fe2759675cd7734dfa',session_name=KING,token=Token}
function var(value)  
...
Status = 0
DevelopersQ = Redis:sismember(KING.."DevelopersQ:Groups",UserId) 
HELPBEVQ = Redis:sismember(KING.."HELPBEVQ:Groups",UserId) 
Developers = Redis:sismember(KING.."Developers:Groups",UserId) 
TheBasics = Redis:sismember(KING.."TheBasics:Group"..ChatId,UserId) 
TheBasicsQ = Redis:sismember(KING.."TheBasicsQ:Group"..ChatId,UserId) 
Originators = Redis:sismember(KING.."Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(KING.."Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(KING.."Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(KING.."Distinguished:Group"..ChatId,UserId)
...
Status = Redis:get(KING.."Developer:Bot:Reply"..ChatId) or 'المطور'
elseif TheBasicsQ then
Status = Redis:get(KING.."PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif TheBasics then
Status = Redis:get(KING.."President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(KING.."Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(KING.."Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(KING.."Admin:Group:Reply"..ChatId) or 'الادمن'
elseif Distinguished then
Status = Redis:get(KING.."Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(KING.."Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(KING.."lockpin"..ChatId) then    
lock_pin = "✅"
else 
lock_pin = "❎"    
end
if Redis:get(KING.."Lock:tagservr"..ChatId) then    
lock_tagservr = "✅"
else 
lock_tagservr = "❎"
end
if Redis:get(KING.."Lock:text"..ChatId) then    
lock_text = "✅"
else 
lock_text = "❎ "    
end
if Redis:get(KING.."Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✅"
else 
lock_add = "❎ "    
end    
if Redis:get(KING.."Lock:Join"..ChatId) == "kick" then
lock_join = "✅"
else 
lock_join = "❎ "    
end    
if Redis:get(KING.."Lock:edit"..ChatId) then    
lock_edit = "✅"
else 
lock_edit = "❎ "    
end
if Redis:get(KING.."Chek:Welcome"..ChatId) then
welcome = "✅"
else 
welcome = "❎ "    
end
if Redis:hget(KING.."Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(KING.."Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(KING.."Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(KING.."Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✅"
else     
flood = "❎ "     
end
if Redis:get(KING.."Lock:Photo"..ChatId) == "del" then
lock_photo = "✅" 
elseif Redis:get(KING.."Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(KING.."Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(KING.."Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❎ "   
end    
if Redis:get(KING.."Lock:Contact"..ChatId) == "del" then
lock_phon = "✅" 
elseif Redis:get(KING.."Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(KING.."Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(KING.."Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❎ "    
end    
if Redis:get(KING.."Lock:Link"..ChatId) == "del" then
lock_links = "✅"
elseif Redis:get(KING.."Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(KING.."Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(KING.."Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❎ "    
end
if Redis:get(KING.."Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✅"
elseif Redis:get(KING.."Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(KING.."Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(KING.."Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❎ "    
end
if Redis:get(KING.."Lock:User:Name"..ChatId) == "del" then
lock_user = "✅"
elseif Redis:get(KING.."Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(KING.."Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(KING.."Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❎ "    
end
if Redis:get(KING.."Lock:hashtak"..ChatId) == "del" then
lock_hash = "✅"
elseif Redis:get(KING.."Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(KING.."Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(KING.."Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❎ "    
end
if Redis:get(KING.."Lock:vico"..ChatId) == "del" then
lock_muse = "✅"
elseif Redis:get(KING.."Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(KING.."Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(KING.."Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❎ "    
end 
if Redis:get(KING.."Lock:Video"..ChatId) == "del" then
lock_ved = "✅"
elseif Redis:get(KING.."Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(KING.."Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(KING.."Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❎ "    
end
if Redis:get(KING.."Lock:Animation"..ChatId) == "del" then
lock_gif = "✅"
elseif Redis:get(KING.."Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(KING.."Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(KING.."Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❎ "    
end
if Redis:get(KING.."Lock:Sticker"..ChatId) == "del" then
lock_ste = "✅"
elseif Redis:get(KING.."Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(KING.."Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(KING.."Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❎ "    
end
if Redis:get(KING.."Lock:geam"..ChatId) == "del" then
lock_geam = "✅"
elseif Redis:get(KING.."Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(KING.."Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(KING.."Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❎ "    
end    
...
if Redis:get(KING.."Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✅"
elseif Redis:get(KING.."Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(KING.."Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(KING.."Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❎ "
end
if Redis:get(KING.."Lock:forward"..ChatId) == "del" then
lock_fwd = "✅"
elseif Redis:get(KING.."Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(KING.."Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(KING.."Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❎ "    
end    
if Redis:get(KING.."Lock:Document"..ChatId) == "del" then
lock_file = "✅"
elseif Redis:get(KING.."Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(KING.."Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(KING.."Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❎ "    
end    
if Redis:get(KING.."Lock:Unsupported"..ChatId) == "del" then
lock_self = "✅"
elseif Redis:get(KING.."Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(KING.."Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(KING.."Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❎ "    
end
if Redis:get(KING.."Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✅"
elseif Redis:get(KING.."Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(KING.."Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❎ "    
end
if Redis:get(KING.."Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✅"
elseif Redis:get(KING.."Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(KING.."Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(KING.."Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❎ "    
end
if Redis:get(KING.."Lock:Spam"..ChatId) == "del" then    
lock_spam = "✅"
elseif Redis:get(KING.."Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(KING.."Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(KING.."Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❎ "    
end        
...
return{
BanAll = Redis:sismember(KING.."BanAll:Groups",UserId) ,
ktmall = Redis:sismember(KING.."ktmAll:Groups",UserId) ,
BanGroup = Redis:sismember(KING.."BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(KING.."SilentGroup:Group"..ChatId,UserId)
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,KING).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local Channel = Redis:get(KING..'Channel:Join')
if Channel then
...
local msg_id = msg.id
var(msg.content)
if data.sender.luatele == "messageSenderChat" and Redis:get(KING.."Lock:channell"..msg_chat_id) then
print(Redis:get(KING.."chadmin"..msg_chat_id))
print(data.sender.chat_id)
if data.sender.chat_id ~= Redis:get(KING.."chadmin"..msg_chat_id) then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
Redis:incr(KING..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
Redis:sadd(KING.."allM"..msg.chat_id, msg.id)
if Redis:get(KING.."Status:Del:Media"..msg.chat_id) then    
local Numbardel = Redis:get(KING.."allM:numdel"..msg.chat_id) or 200
local gmedia = Redis:scard(KING.."allM"..msg.chat_id)  
if tonumber(gmedia) >= tonumber(Numbardel) then
local liste = Redis:smembers(KING.."allM"..msg.chat_id)
...
Redis:del(KING.."allM"..msg.chat_id)
end
end
end
if tonumber(msg.sender.user_id) == tonumber(KING) then
...
elseif Redis:sismember(KING.."DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(KING.."HELPBEVQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 22
msg.Name_Controller = 'المساعد'
elseif Redis:sismember(KING.."Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(KING.."Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(KING.."TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(KING.."PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(KING.."TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(KING.."President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(KING.."Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(KING.."Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(KING.."Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(KING.."Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(KING.."Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(KING.."Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(KING.."Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(KING.."Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(KING) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(KING.."Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(KING.."Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(KING.."Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(KING.."Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(KING.."Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(KING) then
return false
end

local floods = Redis:hget(KING.."Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(KING.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(KING.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(KING.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(KING.."Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(KING.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"◍ قام بالتكرار في الجروب وتم كتمه").Reply,"md",true)  
end
end
Redis:setex(KING.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(KING.."Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(KING.."Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
if text and Redis:get(KING..'lock:Fshar'..msg.chat_id) and not msg.Distinguished then 
...
if text and Redis:get(KING..'lock:Fars'..msg.chat_id) and not msg.Distinguished then 
...
if text and Redis:get(KING..'lock:Cht'..msg.chat_id) and not msg.Distinguished then 
list = {"كس","كسمك","كسختك","عير","كسخالتك","خرا بالله","عير بالله","كسخواتكم","كحاب","مناويج","مناويج","كحبه","ابن الكحبه","فرخ","فروخ","طيزك","طيزختك","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","ابن العرص","منايك","متناك","احا","ابن المتناكه","زبك","عرص","زبي","خول","لبوه","لباوي","ابن اللبوه","منيوك","كسمكك","متناكه","احو","احي","يا عرص","يا خول","قحبه","القحبه","شراميط","العلق","العلوق","العلقه","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","االمنيوك","كسمككك","الشرموطه","ابن العرث","ابن الحيضانه","زبك","خول","زبي","قاحب"}
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
sens = 400  
if Redis:get(KING.."Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(KING.."Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(KING.."Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(KING.."Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(KING.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Developers then -- التوجيه
local Fwd_Group = Redis:get(KING.."Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(KING.."Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(KING.."Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(KING.."Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(KING.."lockpin"..msg_chat_id)
...
Redis:incr(KING.."Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(KING.."Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(KING.."Lock:Bot:kick"..msg_chat_id)
for k,v in pairs(msg.content.member_user_ids) do
local Info_User = LuaTele.getUser(v) 
print(v)
if v == tonumber(KING) then
local N = (Redis:get(KING.."Name:Bot") or "كينج")
photo = LuaTele.getUserProfilePhotos(KING)
...
Redis:set(KING.."Who:Added:Me"..msg_chat_id..":"..v,msg.sender.user_id)
...
Redis:incr(KING.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(KING.."Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(KING.."Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(KING.."Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(KING.."Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(KING.."Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(KING.."Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(KING.."Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(KING.."Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(KING.."Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(KING.."Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(KING.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
...
Redis:del(KING.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(KING.."Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(KING.."Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(KING.."Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(KING.."Lock:Cmd"..msg_chat_id)
...
if (Redis:get(KING..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(KING.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(KING.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(KING.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(KING.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(KING.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(KING.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(KING.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(KING.."List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(KING..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n◍ ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(KING..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(KING.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(KING.."Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(KING.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(KING..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n◍ تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(KING..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(KING.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(KING.."Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(KING.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(KING.."Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(KING.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(KING.."Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(KING.."List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(KING.."Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(KING..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(KING.."Filter:Group:"..DelFilters..msg_chat_id)
if ReplyFilters then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return LuaTele.sendText(msg_chat_id,msg_id,"*◍ لقد تم منع هذه ( "..statusfilter.." ) هنا*\n◍ "..ReplyFilters,"md",true)   
end
end
if text and Redis:get(KING.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(KING.."All:Get:Reides:Commands:Group"..text)
if NewCmmd then
Redis:del(KING.."All:Get:Reides:Commands:Group"..text)
Redis:del(KING.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(KING.."All:Command:List:Group",text)
...
Redis:del(KING.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(KING.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(KING.."All:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(KING.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(KING.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"◍ ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(KING.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(KING.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:set(KING.."All:Get:Reides:Commands:Group"..text,NewCmd)
Redis:sadd(KING.."All:Command:List:Group",text)
Redis:del(KING.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم حفظ الامر باسم ← { "..text..' }',"md",true)
end

if text and Redis:get(KING.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(KING.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(KING.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(KING.."Command:Reids:Group:New"..msg_chat_id)
Redis:srem(KING.."Command:List:Group"..msg_chat_id,text)
LuaTele.sendText(msg_chat_id,msg_id,"◍ تم ازالة هاذا ← { "..text.." }","md",true)
else
LuaTele.sendText(msg_chat_id,msg_id,"◍ لا يوجد امر بهاذا الاسم","md",true)
end
Redis:del(KING.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(KING.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(KING.."Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(KING.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(KING.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"◍ ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(KING.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(KING.."Command:Reids:Group:New"..msg_chat_id)
Redis:set(KING.."Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(KING.."Command:List:Group"..msg_chat_id,text)
Redis:del(KING.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم حفظ الامر باسم ← { "..text..' }',"md",true)
end
if Redis:get(KING.."Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(KING.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(KING.."Group:Link"..msg_chat_id,LinkGroup)
Redis:del(KING.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"📥︙تم حفظ الرابط بنجاح","md",true)         
end
end 
if Redis:get(KING.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(KING.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(KING.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(KING.."Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم حفظ ترحيب الجروب","md",true)     
end
if Redis:get(KING.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(KING.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(KING.."Group:Rules" .. msg_chat_id,text) 
Redis:del(KING.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم حفظ قوانين الجروب","md",true)  
end  
if Redis:get(KING.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(KING.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
if Redis:get(KING.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ◍' then   
Redis:del(KING.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n◍ تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(KING.."ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(KING.."PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(KING.."PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(KING.."PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(KING.."PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(KING.."PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(KING.."PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(KING.."PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(KING.."PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v, 0,""..text.."")
Redis:set(KING.."PinMsegees:"..v,text)
end
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(KING.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ◍' then   
Redis:del(KING.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n◍ تم الغاء الاذاعه خاص","md",true)  
end 
local list = Redis:smembers(KING..'Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(KING.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ◍' then   
Redis:del(KING.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n◍ تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(KING.."ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(KING.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ◍' then   
Redis:del(KING.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(KING.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ◍' then   
Redis:del(KING.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(KING.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(KING.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(KING.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id)
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(KING.."Add:Rd:Manager:Text"..test..msg_chat_id, text)  
elseif msg.content.sticker then   
Redis:set(KING.."Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(KING.."Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
elseif msg.content.audio then
Redis:set(KING.."Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
Redis:set(KING.."Add:Rd:Manager:Audioc"..test..msg_chat_id, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(KING.."Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
elseif msg.content.animation then
Redis:set(KING.."Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
elseif msg.content.video_note then
Redis:set(KING.."Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.video then
Redis:set(KING.."Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
Redis:set(KING.."Add:Rd:Manager:Videoc"..test..msg_chat_id, msg.content.caption.text)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(KING.."Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
Redis:set(KING.."Add:Rd:Manager:Photoc"..test..msg_chat_id, msg.content.caption.text)  
end
...
if Redis:get(KING.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(KING.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(KING.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(KING.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(KING.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(KING.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(KING.."Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(KING.."Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(KING.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
Redis:del(KING.."Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(KING.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
Redis:del(KING.."Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(KING.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(KING.."Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:del(KING.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
Redis:sadd(KING.."List:Manager"..msg_chat_id.."", text)
...
if text and text:match("^(.*)$") then
if Redis:get(KING.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(KING.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(KING.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(KING.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(KING.."Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(KING.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(KING.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(KING.."List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"◍  تم حذف الرد من الردود ","md",true)  
return false
end
end
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo and msg.sender.user_id ~= KING then
local test = Redis:get(KING.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(KING.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(KING.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(KING.."Add:Rd:Sudo:Text"..test, text)  
elseif msg.content.sticker then   
Redis:set(KING.."Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(KING.."Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
elseif msg.content.animation then   
Redis:set(KING.."Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
elseif msg.content.audio then
Redis:set(KING.."Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
Redis:set(KING.."Add:Rd:Sudo:Audioc"..test, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(KING.."Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
elseif msg.content.video then
Redis:set(KING.."Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
Redis:set(KING.."Add:Rd:Sudo:Videoc"..test, msg.content.caption.text)  
elseif msg.content.video_note then
Redis:set(KING.."Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(KING.."Add:Rd:Sudo:Photo"..test, idPhoto)  
Redis:set(KING.."Add:Rd:Sudo:Photoc"..test, msg.content.caption.text)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(KING.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(KING.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(KING.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(KING.."List:Rd:Sudo", text)
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(KING.."Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
for k,v in pairs(list) do
Redis:del(KING..v..text)
end
Redis:del(KING.."Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(KING.."List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"◍  تم حذف الرد من الردود العامه","md",true)  
end
end
if text then
if not Redis:sismember(KING..'Spam:Group'..msg.sender.user_id,text) then
local anemi = Redis:get(KING.."Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(KING.."Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(KING.."Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(KING.."Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(KING.."Add:Rd:Sudo:Photo"..text)
local photoc = Redis:get(KING.."Add:Rd:Sudo:Photoc"..text)
local video = Redis:get(KING.."Add:Rd:Sudo:Video"..text)
local videoc = Redis:get(KING.."Add:Rd:Sudo:Videoc"..text)
local document = Redis:get(KING.."Add:Rd:Sudo:File"..text)
local audio = Redis:get(KING.."Add:Rd:Sudo:Audio"..text)
local audioc = Redis:get(KING.."Add:Rd:Sudo:Audioc"..text)
local video_note = Redis:get(KING.."Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(KING..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(KING..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
Redis:sadd(KING.."Spam:Group"..msg.sender.user_id,text) 
end
if photo then
...
if text then
local anemi = Redis:get(KING.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(KING.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(KING.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(KING.."Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(KING.."Add:Rd:Manager:Photo"..text..msg_chat_id)
local photoc = Redis:get(KING.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
local video = Redis:get(KING.."Add:Rd:Manager:Video"..text..msg_chat_id)
local videoc = Redis:get(KING.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
local document = Redis:get(KING.."Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(KING.."Add:Rd:Manager:Audio"..text..msg_chat_id)
local audioc = Redis:get(KING.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
local video_note = Redis:get(KING.."Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(KING..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
------------------------------------------------------------------------------------------------------------
if text and Redis:get(KING..'GetTexting:DevKING'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر ◍' then 
Redis:del(KING..'GetTexting:DevKING'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'◍ تم الغاء حفظ كليشة المطور')
end
Redis:set(KING..'Texting:DevKING',text)
Redis:del(KING..'GetTexting:DevKING'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'◍ تم حفظ كليشة المطور')
end
if Redis:get(KING.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n◍ تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(KING.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(KING.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(KING.."Set:Id:Groups",text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'◍ تم تعين الايدي عام',"md",true)  
end
if Redis:get(KING.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n◍ تم الغاء امر تعين الايدي","md",true)  
Redis:del(KING.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(KING.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(KING.."Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'◍ تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(KING.."Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ◍' then   
Redis:del(KING.."Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n◍ تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(KING.."Change:Name:Bot"..msg.sender.user_id) 
Redis:set(KING.."Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "◍  تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(KING.."Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ◍' then   
Redis:del(KING.."Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n◍ تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(KING.."Change:Start:Bot"..msg.sender.user_id) 
Redis:set(KING.."Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "◍  تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(KING.."Game:Smile"..msg.chat_id) then
if text == Redis:get(KING.."Game:Smile"..msg.chat_id) then
Redis:incrby(KING.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(KING.."Game:Smile"..msg.chat_id)
...
if Redis:get(KING.."Game:Monotonous"..msg.chat_id) then
if text == Redis:get(KING.."Game:Monotonous"..msg.chat_id) then
Redis:del(KING.."Game:Monotonous"..msg.chat_id)
Redis:incrby(KING.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(KING.."Game:Countrygof"..msg.chat_id) then
if text == Redis:get(KING.."Game:Countrygof"..msg.chat_id) then
Redis:incrby(KING.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(KING.."Game:Countrygof"..msg.chat_id)
...
if Redis:get(KING.."Game:Riddles"..msg.chat_id) then
if text == Redis:get(KING.."Game:Riddles"..msg.chat_id) then
Redis:incrby(KING.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(KING.."Game:Riddles"..msg.chat_id)
...
if Redis:get(KING.."Game:Meaningof"..msg.chat_id) then
if text == Redis:get(KING.."Game:Meaningof"..msg.chat_id) then
Redis:incrby(KING.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(KING.."Game:Meaningof"..msg.chat_id)
...
if Redis:get(KING.."Game:Reflection"..msg.chat_id) then
if text == Redis:get(KING.."Game:Reflection"..msg.chat_id) then
Redis:incrby(KING.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(KING.."Game:Reflection"..msg.chat_id)
...
if Redis:get(KING.."Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"◍ عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(KING.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(KING.."SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(KING.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(KING.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"◍ مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(KING.."SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(KING.."SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(KING.."SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(KING.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(KING.."Game:Difference"..msg.chat_id) then
if text == Redis:get(KING.."Game:Difference"..msg.chat_id) then 
Redis:del(KING.."Game:Difference"..msg.chat_id)
Redis:incrby(KING.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(KING.."Game:Example"..msg.chat_id) then
if text == Redis:get(KING.."Game:Example"..msg.chat_id) then 
Redis:del(KING.."Game:Example"..msg.chat_id)
Redis:incrby(KING.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if text then
local NewCmmd = Redis:get(KING.."All:Get:Reides:Commands:Group"..text) or Redis:get(KING.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(KING..'Channel:Join')}, },}}
...
if tonumber(KING) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'◍ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(KING..'Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(KING.."ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(KING.."TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(KING.."Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(KING.."Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(KING.."Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(KING.."Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(KING) then 
return LuaTele.sendText(msg_chat_id,msg_id,'◍ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(KING.."ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(KING.."Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(KING.."Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(KING.."Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(KING.."TheBasics:Group"..idg,idASAS)
end;end
end
...
os.execute('wget https://adfrv.zzz.com.ua/beb/KING.lua')
...
Redis:set(KING.."LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(KING.."AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == 'الغاء الامر ◍' then   
Redis:del(KING.."AddSudosNew"..msg_chat_id)
...
local Groups = Redis:smembers(KING..'ChekBotAdd')  
local UsersBot = Redis:smembers(KING..'Num:User:Pv')  
local Get_Json = '{"BotId": '..KING..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(KING.."TheBasics:Group"..v)
local Constructor = Redis:smembers(KING.."Originators:Group"..v)
local Manager = Redis:smembers(KING.."Managers:Group"..v)
local Admin = Redis:smembers(KING.."Addictive:Group"..v)
local Vips = Redis:smembers(KING.."Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
if (Redis:get(KING..'Channel:Redis'..msg_chat_id..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر ◍' then 
Redis:del(KING..'Channel:Redis'..msg_chat_id..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(bana.id,KING).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n◍ البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(KING..'Channel:Join',ChannelUser) 
...
Redis:set(KING..'Channel:Redis'..msg_chat_id..msg.sender.user_id,true)
...
Redis:set(KING..'Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'*◍ عدد احصائيات البوت الكامله \n ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳\n◍ عدد المجموعات : '..(Redis:scard(KING..'ChekBotAdd') or 0)..'\n◍ عدد المشتركين : '..(Redis:scard(KING..'Num:User:Pv') or 0)..'*',"md",true)  
end
...
if Redis:sismember(KING.."ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(KING..'Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'◍ عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(KING..'Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(KING.."ChekBotAdd",msg_chat_id)
Redis:set(KING.."Status:Id"..msg_chat_id,true) ;Redis:set(KING.."Status:Reply"..msg_chat_id,true) ;Redis:set(KING.."Status:ReplySudo"..msg_chat_id,true) ;Redis:set(KING.."Status:BanId"..msg_chat_id,true) ;Redis:set(KING.."Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(KING.."BotFree") then
...
sec = time.sec
local_time = hour..":"..min
list_zkr = Redis:smembers(KING.."ChekBotAdd")
if local_time then
if local_time == "0:0" and not Redis:get(KING.."0:done") then 
if Redis:get(KING.."Status:tfil"..msg.chat_id) then
if not msg.ControllerBot then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
...
Redis:sadd(KING.."ChekBotAdd",msg_chat_id)
Redis:set(KING.."Status:Id",true);Redis:set(KING.."Status:Games",true)  ;Redis:set(KING.."Status:Reply",true) ;Redis:set(KING.."Status:ReplySudo",true) ;Redis:set(KING.."Status:BanId",true) ;Redis:set(KING.."Status:SetId",true) 
end
Redis:set(KING.."0:done", true)
for i = 1 , 23 ,1 do 
Redis:del(KING..i..":done")
end
end
end
end
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(KING.."ChekBotAdd",msg_chat_id) then
...
Redis:srem(KING.."ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(KING.."ChekBotAdd",msg_chat_id) then
if text == "ايدي" or text =='id' or text =='Id' or text == 'ID' and msg.reply_to_message_id == 0 then
if not Redis:get(KING.."Status:Id"..msg_chat_id) then
return false
end
...
local TotalMsg = Redis:get(KING..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(KING..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(KING.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(KING.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(KING.."Set:Id:Groups") or Redis:get(KING.."Set:Id:Group"..msg_chat_id)
if Redis:get(KING.."Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(KING..'Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(KING..'Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(KING.."Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(KING.."Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
...
Redis:set(KING.."allM:numdel"..msg.chat_id,Numbardel) 
...
local list = Redis:smembers(KING.."allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(KING.."allM"..msg.chat_id)  
...
Redis:del(KING.."Status:Del:Media"..msg.chat_id)
...
Redis:set(KING.."Status:Del:Media"..msg.chat_id,true)
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,KING).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'◍ البوت عضو في الجروب ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,KING).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✅ ❭' else change_info = '❬ ❎ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(KING.."HELPBEVQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(KING.."HELPBEVQ:Groups")
Redis:del(KING.."HELPBEVQ:Groups", bana.id)
Redis:del(KING.."id:HELPBEVQ:Groups", bana.id)
...
if not Redis:sismember(KING.."Developers:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(KING.."Developers:Groups",bana.id) 
...
if not Redis:sismember(KING.."TheBasicsQ:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(KING.."TheBasicsQ:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(KING.."TheBasics:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(KING.."TheBasics:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(KING.."Originators:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(KING.."Originators:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(KING.."Managers:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(KING.."Managers:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(KING.."Addictive:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(KING.."Addictive:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(KING.."Distinguished:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(KING.."Distinguished:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(KING.."DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(KING.."DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(KING.."HELPBEVQ:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(KING.."HELPBEVQ:Groups")
Redis:del(KING.."HELPBEVQ:Groups", Message_Reply.sender.user_id)
Redis:del(KING.."id:HELPBEVQ:Groups", Message_Reply.sender.user_id)
...
if not Redis:sismember(KING.."Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(KING.."Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(KING.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(KING.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(KING.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(KING.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(KING.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(KING.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(KING.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(KING.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(KING.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(KING.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(KING.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(KING.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ تم تنزيله من المميزبن ").Reply,"md",true)  
end
end
----تنزيل تسليه -----
if TextMsg == "خول" then
if not Redis:sismember(KING.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(KING.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(KING.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(KING.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(KING.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ اتعالج خلاص 🙃 ").Reply,"md",true)  
else
Redis:srem(KING.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "كلب" then
if not Redis:sismember(KING.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(KING.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(KING.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ الحمار دا عقل من زمان   🙃 ").Reply,"md",true)  
else
Redis:srem(KING.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "سمب" then
if not Redis:sismember(KING.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ بطل يمشي ورا الحريم 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(KING.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "قرد" then
if not Redis:sismember(KING.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ بطل يطنط علي شجر 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(KING.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "عره" then
if not Redis:sismember(KING.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ اعقل بقا 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(KING.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "غبي" then
if not Redis:sismember(KING.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ يارب تعقل وتبقا ذكي 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(KING.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(KING.."botaua:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ يارب تعقل 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(KING.."botaua:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(KING.."bwoman:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(KING.."bwoman:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(KING.."alpe:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ اعقل وبلاش خزوقه 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(KING.."alpe:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(KING.."HELPBEVQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◍ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(KING.."HELPBEVQ:Groups")
Redis:del(KING.."HELPBEVQ:Groups", UserId)
Redis:del(KING.."id:HELPBEVQ:Groups", UserId)
...
if not Redis:sismember(KING.."Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◍ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(KING.."Developers:Groups",UserId) 
...
if not Redis:sismember(KING.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(KING.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(KING.."TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(KING.."TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(KING.."Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(KING.."Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(KING.."Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(KING.."Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(KING.."Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(KING.."Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(KING.."Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(KING.."Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(KING.."HELPBEVQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:del(KING.."HELPBEVQ:Groups")
Redis:sadd(KING.."HELPBEVQ:Groups", UserId)
Redis:set(KING.."id:HELPBEVQ:Groups", UserId)
...
if Redis:sismember(KING.."TheBasicsQ:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(KING.."TheBasicsQ:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(KING.."TheBasics:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(KING.."TheBasics:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(KING.."Originators:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(KING.."Originators:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(KING.."Managers:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(KING.."Managers:Group"..msg_chat_id,bana.id) 
...
if not msg.Originators and not Redis:get(KING.."Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(KING.."Addictive:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(KING.."Addictive:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(KING.."Distinguished:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(KING.."Distinguished:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(KING.."DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(KING.."DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(KING.."HELPBEVQ:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ تم ترقيته مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(KING.."HELPBEVQ:Groups")
Redis:sadd(KING.."HELPBEVQ:Groups", Message_Reply.sender.user_id)
Redis:set(KING.."id:HELPBEVQ:Groups", Message_Reply.sender.user_id)
...
if Redis:sismember(KING.."Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(KING.."Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(KING.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(KING.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(KING.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(KING.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(KING.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(KING.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(KING.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(KING.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(KING.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(KING.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(KING.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(KING.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "خول" then
if ChannelJoin(msg) == false then
local chinfo = Redis:get(KING.."ch:admin")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = chinfo}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n◍ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
if Redis:sismember(KING.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(KING.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(KING.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(KING.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(KING.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(KING.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(KING.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(KING.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(KING.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(KING.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(KING.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(KING.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(KING.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(KING.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(KING.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ محدش محترمه كده كده  😂 😂 ").Reply,"md",true)  
else
Redis:sadd(KING.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(KING.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(KING.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(KING.."bwoman:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ هي كد كده محطوط بنتك  😂 😂 ").Reply,"md",true)  
else
Redis:sadd(KING.."bwoman:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(KING.."botaua:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ هو كده كده محطوط ابنك  😂 😂 ").Reply,"md",true)  
else
Redis:sadd(KING.."botaua:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(KING.."alpe:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(KING.."alpe:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(KING.."HELPBEVQ:Groups",UserId) then
...
if Redis:sismember(KING.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(KING.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(KING.."TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(KING.."TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(KING.."Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(KING.."Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(KING.."Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(KING.."Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(KING.."Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(KING.."Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(KING.."Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(KING.."Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(KING.."Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(KING.."President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(KING.."Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(KING.."PresidentQ:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(KING.."Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(KING.."Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(KING.."Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(KING.."DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(KING.."Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"◍ لا يوجد مطورين حاليا , ","md",true)  
end
ListMembers = '\n*◍ قائمه مطورين البوت \n  ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳*\n'
...
local Info_Members = Redis:smembers(KING.."TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(KING.."TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(KING.."Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(KING.."Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(KING.."Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(KING.."Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(KING.."BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(KING.."ktmAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(KING.."BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(KING.."SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(KING.."kholat:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(KING.."wtka:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(KING.."twhd:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(KING.."klb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(KING.."mar:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(KING.."3ra:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(KING.."smb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(KING.."2rd:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(KING.."8by:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(KING.."alpe:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(KING.."botaua:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(KING.."bwoman:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(KING.."Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(KING.."Status:Welcome"..msg_chat_id,true) 
...
Redis:set(KING.."Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(KING.."Status:Reply"..msg_chat_id,true) 
...
Redis:set(KING.."Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(KING.."Status:BanId"..msg_chat_id,true) 
...
Redis:del(KING.."Status:tfil"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم تعطيل التفعيل التلقائي ","md",true)
end
if TextMsg == 'جمالي' then
Redis:del(KING.."Status:gamle"..msg_chat_id) 
...
Redis:del(KING.."Status:Id"..msg_chat_id) 
...
Redis:del(KING.."Status:IdPhoto"..msg_chat_id) 
...
Redis:del(KING.."Status:Reply"..msg_chat_id) 
...
Redis:del(KING.."Status:ReplySudo"..msg_chat_id) 
...
Redis:del(KING.."Status:BanId"..msg_chat_id) 
...
if not msg.Originators and not Redis:get(KING.."Status:BanId"..msg_chat_id) then
...
if Redis:sismember(KING.."BanGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(KING.."BanGroup:Group"..msg_chat_id,bana.id) 
LuaTele.setChatMemberStatus(msg.chat_id,bana.id,'banned',0)
...
if not Redis:sismember(KING.."BanGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(KING.."BanGroup:Group"..msg_chat_id,bana.id) 
LuaTele.setChatMemberStatus(msg.chat_id,bana.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(KING.."SilentGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(KING.."SilentGroup:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(KING.."SilentGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
Redis:srem(KING.."SilentGroup:Group"..msg_chat_id,bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if Redis:sismember(KING.."BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(KING.."BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(KING.."BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(KING.."BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(KING.."ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(KING.."ktmAll:Groups",Message_Reply.sender.user_id) 
if ban.first_name then
baniusername = '*المستخدم :- *['..ban.first_name..'](tg://user?id='..ban.id..')*\nتم كتمه في الجروب\nمن قبل :- *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
baniusername = 'لا يوجد'
...
if not Redis:sismember(KING.."ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(KING.."ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(KING.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(KING.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
if ban.first_name then
baniusername = '*المستخدم :- *['..ban.first_name..'](tg://user?id='..ban.id..')*\n◍ تم حظره من الجروب\nمن قبل :- *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
...
if not Redis:sismember(KING.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(KING.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(KING.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(KING.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
if ban.first_name then
baniusername = '*المستخدم :- *['..ban.first_name..'](tg://user?id='..ban.id..')*\nتم كتمه في الجروب\nمن قبل :- *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
baniusername = 'لا يوجد'
...
if not Redis:sismember(KING.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(KING.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if Redis:sismember(KING.."BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◍ تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(KING.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
if ban.first_name then
...
if not Redis:sismember(KING.."BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◍ تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(KING.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(KING.."SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◍ تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(KING.."SilentGroup:Group"..msg_chat_id,UserId) 
if ban.first_name then
baniusername = '*المستخدم :- *['..ban.first_name..'](tg://user?id='..ban.id..')*\n◍ تم كتمه في الجروب\nمن قبل :- *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
baniusername = 'لا يوجد'
...
if not Redis:sismember(KING.."SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◍ تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
Redis:srem(KING.."SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◍ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if text == "نزلني" then
if not Redis:get(KING.."Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(KING.."DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(KING.."Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(KING.."TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(KING.."TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(KING.."Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(KING.."Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(KING.."Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(KING.."Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(KING.."Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(KING.."Distinguished:Group"..msg_chat_id, msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم تنزيلك من الادمنيه والمميزين ","md",true) 
end
end

if text == "اطردني" or text == "طردني" then
if not Redis:get(KING.."Status:KickMe"..msg_chat_id) then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(KING.."TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(KING.."Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
local id = Redis:get(KING.."id:HELPBEVQ:Groups")
...
local Added_Me = Redis:get(KING.."Who:Added:Me"..msg.sender.user_id..':'..msg.sender.user_id)
if Added_Me then 
...
if tonumber(Message_Reply.sender.user_id) == tonumber(KING) then
...
if not Redis:get(KING.."rb:bna"..msg_chat_id) then
...
if Redis:get(KING.."lockalllll"..msg_chat_id) == "off" then
...
Redis:sadd(KING.."cleaner"..msg_chat_id,msg_id)
end
...
local list = Redis:smembers(KING.."cleaner"..msg_chat_id)
...
---زخرفة ----
if Redis:get(KING.."zhrfa"..msg.sender.user_id) == "sendzh" then
...
LuaTele.sendText(msg_chat_id,msg_id,t,"md",true) 
Redis:del(KING.."zhrfa"..msg.sender.user_id) 
end



if text == "جمالي" or text == 'نسبه جمالي' then
if Redis:get(KING.."Status:gamle"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
if Redis:get(KING.."Status:kool"..msg.chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,m,"md",true) 
end
end
if text == "صورتي" then
if Redis:get(KING.."Status:photo"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
...
if not msg.ControllerBot and not Redis:set(KING.."LeftBot") then
...
if text and Redis:get(KING.."addchannel"..msg.sender.user_id) == "on" then
Redis:set(KING.."chadmin"..msg_chat_id,text) 
LuaTele.sendText(msg_chat_id,msg_id,"◍  تم حفظ ايدي القناه","md",true)  
Redis:del(KING.."addchannel"..msg.sender.user_id)
end
if text == "القناه المضافه" then
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(KING.."chadmin"..msg_chat_id),"md",true)  
end
if text == "اضف قناه" then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*◍ هاذا الامر يخص『 '..Controller_Num(7)..' 』* ',"md",true)  
end
Redis:set(KING.."addchannel"..msg.sender.user_id,"on") 
...
Redis:set(KING.."Lock:channell"..msg_chat_id,true) 
...
Redis:del(KING.."Lock:channell"..msg_chat_id)  
...
Redis:set(KING.."Lock:text"..msg_chat_id,true) 
...
Redis:set(KING.."Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(KING.."Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(KING.."Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(KING.."Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(KING.."Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(KING.."lockalllll"..msg_chat_id,"off")
...
Redis:set(KING.."lockalllll"..msg_chat_id,"on")
...
Redis:set(KING.."lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(KING.."Lock:edit"..msg_chat_id,true) 
...
Redis:set(KING.."Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(KING..''..lock..msg_chat_id,"del")    
end
...
Redis:del(KING.."Lock:AddMempar"..msg_chat_id)  
...
Redis:del(KING.."Lock:text"..msg_chat_id)  
...
Redis:del(KING.."Lock:Join"..msg_chat_id)  
...
Redis:del(KING.."Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(KING.."Lock:tagservr"..msg_chat_id)  
...
Redis:del(KING.."lockpin"..msg_chat_id)  
...
Redis:del(KING.."Lock:edit"..msg_chat_id) 
...
Redis:del(KING.."Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(KING..''..lock..msg_chat_id)    
end
...
Redis:hset(KING.."Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(KING.."Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(KING.."Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(KING.."Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(KING.."Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(KING.."Lock:Link"..msg_chat_id,"del")  
...
Redis:set(KING.."Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(KING.."Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(KING.."Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(KING.."Lock:Link"..msg_chat_id)  
...
Redis:set(KING.."Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(KING.."Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(KING.."Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(KING.."Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(KING.."Lock:User:Name"..msg_chat_id)  
...
Redis:set(KING.."Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(KING.."Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(KING.."Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(KING.."Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(KING.."Lock:hashtak"..msg_chat_id)  
...
Redis:set(KING.."Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(KING.."Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(KING.."Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(KING.."Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:set(KING..'lock:Fshar'..msg.chat_id,true) 
...
Redis:set(KING..'lock:Cht'..msg.chat_id,true) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"◍ تم قفـل السب").Lock,"md",true)  
end
...
Redis:set(KING..'lock:Fars'..msg.chat_id,true) 
...
Redis:del(KING..'lock:Fshar'..msg.chat_id) 
...
Redis:del(KING..'lock:Cht'..msg.chat_id) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"◍ تم فتح السب").unLock,"md",true)  
end
...
Redis:del(KING..'lock:Fars'..msg.chat_id) 
...
Redis:del(KING.."Lock:Cmd"..msg_chat_id)  
...
Redis:set(KING.."Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(KING.."Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(KING.."Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(KING.."Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(KING.."Lock:Photo"..msg_chat_id)  
...
Redis:set(KING.."Lock:Video"..msg_chat_id,"del")  
...
Redis:set(KING.."Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(KING.."Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(KING.."Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(KING.."Lock:Video"..msg_chat_id)  
...
Redis:set(KING.."Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(KING.."Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(KING.."Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(KING.."Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(KING.."Lock:Animation"..msg_chat_id)  
...
Redis:set(KING.."Lock:geam"..msg_chat_id,"del")  
...
Redis:set(KING.."Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(KING.."Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(KING.."Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(KING.."Lock:geam"..msg_chat_id)  
...
Redis:set(KING.."Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(KING.."Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(KING.."Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(KING.."Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(KING.."Lock:Audio"..msg_chat_id)  
...
Redis:set(KING.."Lock:vico"..msg_chat_id,"del")  
...
Redis:set(KING.."Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(KING.."Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(KING.."Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(KING.."Lock:vico"..msg_chat_id)  
...
Redis:set(KING.."Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(KING.."Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(KING.."Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(KING.."Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(KING.."Lock:Keyboard"..msg_chat_id)  
...
Redis:set(KING.."Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(KING.."Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(KING.."Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(KING.."Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(KING.."Lock:Sticker"..msg_chat_id)  
...
Redis:set(KING.."Lock:forward"..msg_chat_id,"del")  
...
Redis:set(KING.."Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(KING.."Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(KING.."Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(KING.."Lock:forward"..msg_chat_id)  
...
Redis:set(KING.."Lock:Document"..msg_chat_id,"del")  
...
Redis:set(KING.."Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(KING.."Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(KING.."Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(KING.."Lock:Document"..msg_chat_id)  
...
Redis:set(KING.."Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(KING.."Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(KING.."Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(KING.."Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(KING.."Lock:Unsupported"..msg_chat_id)  
...
Redis:set(KING.."Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(KING.."Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(KING.."Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(KING.."Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(KING.."Lock:Markdaun"..msg_chat_id)  
...
Redis:set(KING.."Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(KING.."Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(KING.."Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(KING.."Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(KING.."Lock:Contact"..msg_chat_id)  
...
Redis:set(KING.."Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(KING.."Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(KING.."Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(KING.."Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(KING.."Lock:Spam"..msg_chat_id)  
...
Redis:set(KING.."Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(KING.."Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(KING.."Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(KING.."Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(KING.."Lock:Inlen"..msg_chat_id)  
...
Redis:setex(KING.."Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:setex(KING.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(KING.."Status:Welcome"..msg_chat_id) then
...
Redis:del(KING.."Welcome:Group"..msg_chat_id) 
...
Redis:setex(KING.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(KING.."Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم ازالة قوانين الجروب","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(KING.."Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(KING.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(KING.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(KING.."List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(KING.."Filter:Group:"..v..msg_chat_id)  
Redis:srem(KING.."List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(KING.."Filter:Group:"..v..msg_chat_id)   
...
Redis:set(KING..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(KING..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*◍ ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(KING.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(KING.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(KING.."All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(KING.."All:Get:Reides:Commands:Group"..v)
Redis:del(KING.."All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(KING.."All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:set(KING.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id,"◍ الان ارسل لي الامر القديم ...","md",true)
end
...
Redis:set(KING.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id,"◍ ارسل الان الامر الذي قمت بوضعه مكان الامر القديم","md",true)
end
...
local list = Redis:smembers(KING.."Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(KING.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(KING.."Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(KING.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
Command = Command..""..k..": ("..v..") ← {"..Commands.."}\n"
else
Command = Command..""..k..": ("..v..") \n"
...
if Redis:get(KING.."Status:Link"..msg.chat_id) then
Statuslink = '❬ ✅ ❭' else Statuslink = '❬ ❎ ❭'
end
if Redis:get(KING.."Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✅ ❭' else StatusWelcome = '❬ ❎ ❭'
end
if Redis:get(KING.."Status:Id"..msg.chat_id) then
StatusId = '❬ ✅ ❭' else StatusId = '❬ ❎ ❭'
end
if Redis:get(KING.."Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✅ ❭' else StatusIdPhoto = '❬ ❎ ❭'
end
if Redis:get(KING.."Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✅ ❭' else StatusReply = '❬ ❎ ❭'
end
if Redis:get(KING.."Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✅ ❭' else StatusReplySudo = '❬ ❎ ❭'
end
if Redis:get(KING.."Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✅ ❭' else StatusBanId = '❬ ❎ ❭'
end
if Redis:get(KING.."Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✅ ❭' else StatusSetId = '❬ ❎ ❭'
end
if Redis:get(KING.."Status:Games"..msg.chat_id) then
StatusGames = '❬ ✅ ❭' else StatusGames = '❬ ❎ ❭'
end
if Redis:get(KING.."Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✅ ❭' else Statuskickme = '❬ ❎ ❭'
end
if Redis:get(KING.."Status:AddMe"..msg.chat_id) then
...
Rink = 1
elseif Redis:sismember(KING.."DevelopersQ:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(KING.."Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 3
elseif Redis:sismember(KING.."TheBasicsQ:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(KING.."TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(KING.."Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(KING.."Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
elseif Redis:sismember(KING.."Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 8
elseif Redis:sismember(KING.."Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Rink = 1
elseif Redis:sismember(KING.."DevelopersQ:Groups",bana.id)  then
Rink = 2
elseif Redis:sismember(KING.."Developers:Groups",bana.id)  then
Rink = 3
elseif Redis:sismember(KING.."TheBasicsQ:Group"..msg_chat_id, bana.id) then
Rink = 4
elseif Redis:sismember(KING.."TheBasics:Group"..msg_chat_id, bana.id) then
Rink = 5
elseif Redis:sismember(KING.."Originators:Group"..msg_chat_id, bana.id) then
Rink = 6
elseif Redis:sismember(KING.."Managers:Group"..msg_chat_id, bana.id) then
Rink = 7
elseif Redis:sismember(KING.."Addictive:Group"..msg_chat_id, bana.id) then
Rink = 8
elseif Redis:sismember(KING.."Distinguished:Group"..msg_chat_id, bana.id) then
Rink = 9
else
Rink = 10
end
...
Redis:del(KING..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'◍ تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(KING..'Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'◍ تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(KING..'Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'◍ تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'◍ عدد رسائلك هنا *~ '..(Redis:get(KING..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'◍ عدد التعديلات هنا *~ '..(Redis:get(KING..'Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'◍ عدد جهاتك المضافه هنا *~ '..(Redis:get(KING.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(KING.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
◍ ارسل الان النص
◍ يمكنك اضافه :
...
Redis:setex(KING.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
◍ ارسل الان النص
◍ يمكنك اضافه :
◍ `#username` » اسم المستخدم
...
Redis:del(KING.."Set:Id:Group"..msg.chat_id)
...
Redis:del(KING.."DevelopersQ:Groups") 
...
Redis:del(KING.."Developers:Groups") 
...
Redis:del(KING.."TheBasics:Group"..msg_chat_id) 
...
Redis:del(KING.."Originators:Group"..msg_chat_id) 
...
Redis:del(KING.."Managers:Group"..msg_chat_id) 
...
Redis:del(KING.."Addictive:Group"..msg_chat_id) 
...
Redis:del(KING.."Distinguished:Group"..msg_chat_id) 
...
Redis:del(KING.."BanGroup:Group"..msg_chat_id) 
...
Redis:del(KING.."SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(KING.."List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(KING.."Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(KING.."Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(KING.."Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(KING.."Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(KING.."Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(KING.."Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(KING.."Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(KING.."Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(KING.."Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(KING.."List:Manager"..msg_chat_id)
end
...
text = "◍ قائمه الردود \n ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳\n"
for k,v in pairs(list) do
if Redis:get(KING.."Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(KING.."Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(KING.."Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(KING.."Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(KING.."Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(KING.."Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(KING.."Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ◍"
elseif Redis:get(KING.."Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(KING.."Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(KING.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(KING.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
return LuaTele.sendText(msg_chat_id,msg_id,"◍ ارسل الان الكلمه لحذفها من الردود","md",true)  
end
if text and not Redis:sismember(KING.."Spam:Group"..msg.sender.user_id,text) then
Redis:del(KING.."Spam:Group"..msg.sender.user_id) 
end
...
local list = Redis:smembers(KING.."List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(KING.."Add:Rd:Sudo:Gif"..v)   
Redis:del(KING.."Add:Rd:Sudo:vico"..v)   
Redis:del(KING.."Add:Rd:Sudo:stekr"..v)     
Redis:del(KING.."Add:Rd:Sudo:Text"..v)   
Redis:del(KING.."Add:Rd:Sudo:Photoc"..v)
Redis:del(KING.."Add:Rd:Sudo:Photo"..v)
Redis:del(KING.."Add:Rd:Sudo:Video"..v)
Redis:del(KING.."Add:Rd:Sudo:File"..v)
Redis:del(KING.."Add:Rd:Sudo:Audio"..v)
Redis:del(KING.."Add:Rd:Sudo:video_note"..v)
Redis:del(KING.."List:Rd:Sudo")
end
...
text = "\n📝︙قائمة الردود العامه \n ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳\n"
for k,v in pairs(list) do
if Redis:get(KING.."Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(KING.."Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(KING.."Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(KING.."Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(KING.."Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(KING.."Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(KING.."Add:Rd:Sudo:File"..v) then
db = "ملف ◍"
elseif Redis:get(KING.."Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(KING.."Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(KING.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(KING.."Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
if not msg.ControllerBot and not Redis:set(KING.."SendBcBot") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*◍ امر المغادره معطل من قبل الاساسي ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(KING..'Channel:Join')}, },}}
...
Redis:setex(KING.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(KING.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(KING.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(KING.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(KING.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(KING..'GetTexting:DevKING'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(KING..'Texting:DevKING')
...
Redis:setex(KING.."Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(KING.."Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم حذف اسم البوت ","md",true)   
end
if text == 'بوت' or text == 'البوت' then
local photo = LuaTele.getUserProfilePhotos(KING)
local ban = LuaTele.getUser(KING)
local Namebot = (Redis:get(KING.."Name:Bot") or "كينج")
local BotName = {
...
if text == (Redis:get(KING.."Name:Bot") or "كينج") then
local photo = LuaTele.getUserProfilePhotos(KING)
local ban = LuaTele.getUser(KING)
local Namebot = (Redis:get(KING.."Name:Bot") or "كينج")
local BotName = {
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,KING)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*◍ البوت عظو في الجروب سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(KING..'ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(KING..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(KING..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(KING..'ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(KING.."Game:Smile"..msg.chat_id,SM)
...
if Redis:get(KING.."Status:Games"..msg.chat_id) then
Redis:set(KING..":lov_Bots"..msg.sender.user_id,"sendlove") 
Text = 'ارسل اسمك واسم الشخص الثاني،  \n مثال كينج  والمبرمج احمد '
return LuaTele.sendText(msg_chat_id,msg_id,Text,"md",true) 
end
end
if text and Redis:get(KING..":lov_Bots"..msg.sender.user_id) == "sendlove" then
num = {"10","20","30","35","75","34","66","82","23","19","55","8","63","32","27","89","99","98","3","80","49","100","6","0",};
sendnum = num[math.random(#num)]
sl = 'نسبه حب '..text..' هي : '..sendnum..'%'
 LuaTele.sendText(msg_chat_id,msg_id,sl,"md",true) 
Redis:del(KING..":lov_Bots"..msg.sender.user_id)
return false
end
if text == "نسبه الكره" or text == "نسبه كره" and msg.reply_to_message_id == 0  then
if Redis:get(KING.."Status:Games"..msg.chat_id) then
Redis:set(KING..":Cick:krh"..msg.sender.user_id,"sendkrhe") 
Text = 'ارسل اسمك واسم الشخص الثاني،  \n مثال اسد و لبوى'
return LuaTele.sendText(msg_chat_id,msg_id,Text,"md",true) 
end
end
if text and Redis:get(KING..":Cick:krh"..msg.sender.user_id) == "sendkrhe" then
num = {"10","20","30","35","75","34","66","82","23","19","55","8","63","32","27","89","99","98","3","80","49","100","6","0",};
sendnum = num[math.random(#num)]
sl = 'نسبه كره '..text..' هي : '..sendnum..'%'
 LuaTele.sendText(msg_chat_id,msg_id,sl,"md",true) 
Redis:del(KING..":Cick:krh"..msg.sender.user_id)
return false
end
if text == "نسبه رجوله" or text == "نسبه الرجوله" and msg.reply_to_message_id == 0  then
if Redis:get(KING.."Status:Games"..msg.chat_id) then
Redis:set(KING..":hauai"..msg.sender.user_id,"senduau") 
Text = 'ارسل اسم الشخص الذي تريد قياس نسبه رجولته \n مثال كينج '
return LuaTele.sendText(msg_chat_id,msg_id,Text,"md",true) 
end
end
if text and Redis:get(KING..":hauai"..msg.sender.user_id) == "senduau" then
num = {"10","20","30","35","75","34","66","82","23","19","55","8","63","32","27","89","99","98","3","80","49","100","6","0",};
sendnum = num[math.random(#num)]
sl = 'نسبه رجوله '..text..' هي : \n '..sendnum..'%'
 LuaTele.sendText(msg_chat_id,msg_id,sl,"md",true) 
Redis:del(KING..":hauai"..msg.sender.user_id)
return false
end
if text == "نسبه الانوثه" or text == "نسبه انوثه"  and msg.reply_to_message_id == 0  then
if Redis:get(KING.."Status:Games"..msg.chat_id) then
Redis:set(KING..":lov_cahgf"..msg.sender.user_id,"oaoaiia") 
Text = 'ارسل اسم الشخص الذي تريد قياس نسبه انوثتها \n مثال روان'
return LuaTele.sendText(msg_chat_id,msg_id,Text,"md",true) 
end
end
if text and Redis:get(KING..":lov_cahgf"..msg.sender.user_id) == "oaoaiia" then
num = {"10","20","30","35","75","34","66","82","23","19","55","8","63","32","27","89","99","98","3","80","49","100","6","0",};
sendnum = num[math.random(#num)]
sl = 'نسبه الانوثه '..text..' هي : \n '..sendnum..'%'
 LuaTele.sendText(msg_chat_id,msg_id,sl,"md",true) 
Redis:del(KING..":lov_cahgf"..msg.sender.user_id)
return false
end
if text == "كشف الكدب" or text == "كشف الكذب" and msg.reply_to_message_id == 0  then
if Redis:get(KING.."Status:Games"..msg.chat_id) then
Redis:set(KING..":kahzm"..msg.sender.user_id,"sendnumh") 
Text = 'ارسل لى الجمله لتعرف صدق ام كذب🌚✨'
return LuaTele.sendText(msg_chat_id,msg_id,Text,"md",true) 
end
end
if text and Redis:get(KING..":kahzm"..msg.sender.user_id) == "sendnumh" then
...
sl = ' ⟨  '..text..'  ⟩ \n '..sendnum..' '
 LuaTele.sendText(msg_chat_id,msg_id,sl,"md",true) 
Redis:del(KING..":kahzm"..msg.sender.user_id)
return false
end
...
if Redis:get(KING.."Status:Games"..msg.chat_id) then
Redis:del(KING.."Set:Country"..msg.chat_id)
...
Redis:set(KING.."Game:Countrygof"..msg.chat_id,name)
...
if Redis:get(KING.."Status:Games"..msg.chat_id) then
KlamKING = {"سحور","سياره","استقبال","قنفه","ايفون","بزونه","مطبخ","كرستيانو","دجاجه","مدرسه","الوان","غرفه","ثلاجه","كهوه","سفينه","العراق","محطه","طياره","رادار","منزل","مستشفى","كهرباء","تفاحه","اخطبوط","سلمون","فرنسا","برتقاله","تفاح","مطرقه","بتيته","لهانه","شباك","باص","سمكه","ذباب","تلفاز","حاسوب","انترنيت","ساحه","جسر"};
name = KlamKING[math.random(#KlamKING)]
Redis:set(KING.."Game:Monotonous"..msg.chat_id,name)
...
Redis:set(KING.."Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(KING.."Status:Games"..msg.chat_id) then
Redis:del(KING.."Set:Maany"..msg.chat_id)
...
Redis:set(KING.."Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(KING.."Status:Games"..msg.chat_id) then
Redis:del(KING.."Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(KING.."Game:Reflection"..msg.chat_id,name)
...
Redis:set(KING.."Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(KING.."Game:Difference"..msg.chat_id,name)
...
Redis:set(KING.."Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(KING.."Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(KING.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(KING.."Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(KING.."Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(KING.."Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(KING.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(KING.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(KING.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(KING.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(KING.."Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(KING.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(KING.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(KING.."Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(KING.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(KING.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(KING.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(KING.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(KING.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','الردود')
Redis:set(KING.."Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(KING.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(KING.."Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(KING.."Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(KING.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(KING.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع كينج')
...
local ban = LuaTele.getUser(KING)
local bain = LuaTele.getUser(msg.sender.user_id)
Redis:sadd(KING..'Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(KING.."Start:Bot") then
...
local CmdStart = '*\n◍ أهلآ بك في بوت '..(Redis:get(KING.."Name:Bot") or "كينج")..
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(KING.."Start:Bot"),"md",false, false, false, false, reply_markup)
end
end
else
...
Redis:setex(KING.."Change:Start:Bot"..msg.sender.user_id,300,true) 
...
if not msg.ControllerBot then
if Redis:get(KING.."TwaslBot") and not Redis:sismember(KING.."BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(KING.."Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(KING.."Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(KING..'BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'◍ تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(KING..'BaN:In:Tuasl',Info_User)  
...
Redis:srem(KING.."ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(KING..'*'..'-100'..data.supergroup.id..'*')
Redis:del(KING.."List:Manager"..'-100'..data.supergroup.id)
Redis:del(KING.."Command:List:Group"..'-100'..data.supergroup.id)
for i = 1, #keys do 
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(KING.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(KING.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(KING.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(KING.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(KING.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(KING.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(KING.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(KING.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(KING.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(KING.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(KING.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(KING.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(KING.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(KING.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(KING.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(KING.."PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(KING.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(KING.."PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(KING.."Lock:tagservr"..data.message.chat_id) then
LuaTele.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender.user_id) == tonumber(KING) then
return false
end
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(KING..'Status:joinet'..data.message.chat_id) == 'true' then
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
...
if Message_Edit.sender.user_id == KING then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(KING..'Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(KING.."Lock:edit"..data.chat_id) then
...
local inget = Redis:get(KING..'bainbots'..ramsesadd[3]..data.sender_user_id)
...
Redis:set(KING..'bainbots'..idnum..UserId_Info.id,username[1])
Redis:set(KING..'bainbots'..idnum..data.sender_user_id,username[1])
end
end
end
...
Redis:incrby(KING.."Num:Add:Games"..ChatId..IdUser, 1)  
...
Redis:set(KING.."zhrfa"..IdUser,"sendzh") 
end 
if Text == '/leftz@' then
LuaTele.editMessageText(ChatId,Msg_id,"*◍ ارسل الكلمه لزخرفتها عربي او انجلش*","md",true) 
Redis:set(KING.."zhrfa"..IdUser,"sendzh") 
...
Redis:set(KING.."rank_tf"..IdUser,"rank_tk") 
end
end 
...
Redis:set(KING.."AddSudosNew"..ChatId,true)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."AddSudosNew"..ChatId)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(KING.."Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(KING.."Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(KING.."Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(KING.."Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."rb:bna"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(KING.."Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"◍ تم تفعيل امر اطردني").unLock, 'md', true, false, reply_markup)
end
end
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(KING.."TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(KING.."Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(KING.."Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(KING..''..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:del(KING.."Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(KING..''..lock..UserId[2],"del")    
end
LuaTele.answerCallbackQuery(data.id, "◍ تم قفل جميع الاوامر بنجاح  ", true)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(KING.."Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."BanGroup:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."kholat:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."wtka:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ' ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳', url = 't.me/SOo_KING/408'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."twhd:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ' ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳', url = 't.me/SOo_KING/408'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."klb:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ' ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳', url = 't.me/SOo_KING/408'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."mar:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ' ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳', url = 't.me/SOo_KING/408'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."smb:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ' ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳', url = 't.me/SOo_KING/408'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."2rd:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ' ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳', url = 't.me/SOo_KING/408'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."3ra:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ' ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳', url = 't.me/SOo_KING/408'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."alpe:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ' ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳', url = 't.me/SOo_KING/408'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."bwoman:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ' ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳', url = 't.me/SOo_KING/408'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."botaua:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ' ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳', url = 't.me/SOo_KING/408'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."8by:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ' ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳', url = 't.me/SOo_KING/408'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(KING.."SilentGroup:Group"..ChatId) 
